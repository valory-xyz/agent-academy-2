...
from packages.valory.skills.preparetx_abci.behaviours import (
    PrepareTxBehaviour,
    PrepareTxAbciConsensusBehaviour,
)
...
class PrepareTxAbciFSMBehaviourBaseCase(BaseSkillTestCase):
    ...
    preparetx_abci_behaviour: PrepareTxAbciConsensusBehaviour
    ...
    def setup(cls, **kwargs: Any) -> None:
        ...
        cls.preparetx_abci_behaviour.setup()
    ...
    def end_round(
        ...
        current_state = cast(BaseState, self.preparetx_abci_behaviour.current_state)
        ...
        self.preparetx_abci_behaviour._process_current_round()
    ...
    def _test_done_flag_set(self) -> None:
        ...
        with mock.patch.object(
            self.preparetx_abci_behaviour.context.state, "_period"
        ) as mock_period:
...
class BasePrepareTxBehaviourTest(PrepareTxAbciFSMBehaviourBaseCase):
    """Test SelectKeeperBehaviour."""

    preparetx_behaviour_class: Type[BaseState]
    ...
    def test_preparetx(
        ...
        assert (
            cast(
                BaseState,
                cast(BaseState, self.preparetx_abci_behaviour.current_state),
            ).state_id
            == self.preparetx_behaviour_class.state_id
        )
        self.preparetx_abci_behaviour.act_wrapper()
        ...
        self.end_round()
        state = cast(BaseState, self.preparetx_abci_behaviour.current_state)
