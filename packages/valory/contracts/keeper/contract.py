...
class KeeperContract(Contract):
    ...
    def get_raw_work_transaction(
        ...
        **kwargs: Any
        ...
        account_address = checksum_address(self.context.agent_address)

        job_contract = cls.get_instance(ledger_api, job_contract_address)
        job_tx_data = HexBytes(safe_contract.functions.work().buildTransaction(  # type: ignore
