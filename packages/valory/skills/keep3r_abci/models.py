...
from packages.valory.skills.keep3r_job.models import RandomnessApi as BaseRandomnessApi
from packages.valory.skills.keep3r_job.models import SharedState as Keep3rJobSharedState
