...
from packages.valory.skills.keep3r_abci.dialogues import HttpDialogue, HttpDialogues
from packages.valory.skills.keep3r_abci.models import SharedState
from packages.valory.skills.keep3r_job_abci.rounds import SynchronizedData
...
class HttpHandler(BaseHttpHandler):
    ...
    def setup(self) -> None:
        ...
        self.handler_url_regex = (
            rf"{hostname_regex}\/.*"  # pylint: disable=attribute-defined-outside-init
        )
    ...
    def _handle_get_health(
        ...
        if round_sequence._abci_app:  # pylint: disable=protected-access
            current_round = (
                round_sequence._abci_app.current_round.round_id
            )  # pylint: disable=protected-access
            previous_rounds = [
                r.round_id
                for r in round_sequence._abci_app._previous_rounds[
                    -10:
                ]  # pylint: disable=protected-access
            ]
